      ...
      <div className="flex flex-row gap-36">
        <div className="flex flex-col gap-6 text-base/7">
          ...
          <div className="flex flex-col gap-6 text-lg text-content-secondary">
            ...
            <p>Over time, working closely with teams to create user-focused solutions was rewarding, but I found myself missing the problem-solving aspect of development — the challenge of figuring out how to make things work. I missed the thrill of solving complex challenges and the satisfaction of building functional, interactive experiences from stratch.</p>
