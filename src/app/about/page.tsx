    ...
    <div className="flex flex-col gap-16">
      ...
      <div className="flex flex-col sm:gap-8 border-t">
        ...
        <div className="flex flex-col w-full pb-16">
          <WorkItem startDate="Sep 22" role="Product Designer" company="AB InBev" website="https://www.ab-inbev.com/" sector="E-commerce/SaaS" description="AB InBev is a global beverage and brewing leader, and owns brands like Budweiser, Corona, and Stella Artois. I led a developer web portal redesign with cross-functional teams, boosting system usability by 9.63%, user satisfaction by 9.21%, and task efficiency by 13.97% in 3 months. I also led development of multiple features for other apps including admin tools, ERP integration, order and deliveries management, resulting in increased efficiency and cost savings." location="Remote" current />
          <WorkItem 
            startDate="Aug 21" endDate="Feb 22" role="Product Designer" company="fluke" website="https://flu.ke/" sector="Healthcare" description="fluke is a brazilian Mobile Virtual Network Operator focused on simplifying processes that are commonly bureaucratic in traditional mobile operators in Brazil. I was responsible for multiple improvements of the SIM card acquisition flow, which resulted in a user contact rate
reduction and increased customer satisfaction." location="Remote" current={false} />
          ...
          <WorkItem startDate="Jul 20" endDate="Aug 21" role="Product Designer" company="dti digital + Ânima Educação" website="https://www.dtidigital.com.br/" sector="Higher education" description="Ânima Educação is a company responsible for managing multiple private universities within Brazil. I helped to build a web platform that allowed their internal staff from Ânima to generate Bachelor’s and Master’s certificates for their 350.000+ students, following the Brazilian Ministry of Education requirements." location="Remote" current={false} />
          <WorkItem startDate="Apr 19" endDate="Jul 20" role="Full Stack Developer" company="dti digital + Localiza&Co" website="https://www.dtidigital.com.br/" sector="Urban mobility" description="Localiza&Co offers complete mobility solutions for individuals and businesses, including car rentals, car subscriptions, fleet outsourcing, and sales of vehicles, operating across 7 countries in Latin America through franchises. There, I was a mobile and backend developer for an app migration from hybrid to native used by thier carport operators." location="Belo Horizonte, Brazil" current={false} />
        </div>
      </div>
