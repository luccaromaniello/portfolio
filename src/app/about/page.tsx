    ...
    <div className="flex flex-col gap-4 sm:gap-16 pt-8 sm:pt-12">
      <div className="flex flex-col sm:flex-row gap-32 pb-16 items-center">
        <div className="flex flex-col gap-6 text-base/7">
          ...
          <div className="flex flex-col gap-6 text-md sm:text-lg text-content-secondary">
            <p>I began my career as a software developer, where I quickly discovered the power of technology to bring ideas to life. As I collaborated with talented designers, I grew interested in the creative side of development, which led me to shift towards product design.</p>
            <p>Despite the shift, I continued to develop my technical expertise in Software Engineering. Over time, working closely with teams to create user-focused solutions was rewarding, but I found myself missing the problem-solving aspect of development — the thrill of solving complex challenges and building interactive experiences from scratch.</p>
        ...
        <div className="hidden sm:block flex flex-row basis-64 shrink-0 relative">
          <Image
      ...
      <div className="flex flex-col gap-4 sm:gap-8 border-t">
        ...
        <div className="flex flex-col w-full pb-8">
          ...
          <WorkItem 
            startDate="Aug 21" endDate="Feb 22" role="Product Designer" company="fluke" website="https://flu.ke/" sector="Healthcare" technologies={["Design workshops", "Customer experience", "Data visualization"]} description="fluke is a brazilian Mobile Virtual Network Operator focused on simplifying processes that are commonly bureaucratic in traditional mobile operators in Brazil. I was responsible for multiple improvements of the SIM card acquisition flow, which resulted in a user contact rate
reduction and increased customer satisfaction." location="Remote" current={false} />
          <WorkItem startDate="Feb 22" endDate="Sep 22" role="Product Designer" company="Conexa Saúde" website="https://www.conexasaude.com.br/" sector="Mobile network" technologies={["Prototyping", "User interviews"]} description="Conexa Saúde is recognized as the largest integrated healthcare platform in Latin America, facilitating connections between patients, doctors, and healthcare institutions through telemedicine services. I contributed to multiple improvements in the doctors' experience, actively participating from conception to implementation of various features." location="Remote" current={false} />
          <WorkItem startDate="Jul 20" endDate="Aug 21" role="Product Designer" company="dti digital + Ânima Educação" website="https://www.dtidigital.com.br/" sector="Higher education" technologies={["UI/UX design", "Design systems", "Usability testing"]} description="Ânima Educação is a company responsible for managing multiple private universities within Brazil. I helped to build a web platform that allowed their internal staff from Ânima to generate Bachelor’s and Master’s certificates for their 350.000+ students, following the Brazilian Ministry of Education requirements." location="Remote" current={false} />
          <WorkItem startDate="Apr 19" endDate="Jul 20" role="Full Stack Developer" company="dti digital + Localiza&Co" website="https://www.dtidigital.com.br/" sector="Urban mobility" technologies={["React.js", "Vue.js", "ASP.NET", "Kotlin", "Flutter"]} description="Localiza&Co offers complete mobility solutions for individuals and businesses, including car rentals, car subscriptions, fleet outsourcing, and sales of vehicles, operating across 7 countries in Latin America through franchises. There, I was a mobile and backend developer for an app migration from hybrid to native used by thier carport operators. I also worked a frontend developer for an internal software used for visual management and merit money." location="Belo Horizonte, Brazil" current={false} />
        </div>
      </div>
