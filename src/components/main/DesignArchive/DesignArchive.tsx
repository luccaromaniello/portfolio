...
const DesignArchive = () => {
  ...
  return (
    <div className="flex flex-col gap-16 items-center">
      <h3 className="text-lg uppercase text-content-secondary">
        Design archive
      </h3>
      <div className="grid grid-cols-1 grid-rows-4 sm:grid-cols-2 sm:grid-rows-2 gap-24 sm:justify-between">
        {projects.map(
          (
